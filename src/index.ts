...
await bot.api.setMyCommands([
  ...
  {
    command: "respawn",
    description: "Kill + restart current session, same cwd",
  },
  ...
  { command: "unwatch", description: "Stop watching this topic's session" },
  { command: "pin", description: "Update pinned status message" },
